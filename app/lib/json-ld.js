...
export function buildSoftwareApplicationLd() {
  return {
    ...
    softwareVersion: '3',
    url: SITE_URL,
    codeRepository: 'https://github.com/NFSFU234FormValidation/nfsfu234-form-validation',
    license: 'https://github.com/NFSFU234FormValidation/nfsfu234-form-validation/blob/main/LICENSE',
